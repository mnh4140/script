...
CHECK_DIR="$SECURITY_DIR/check"

source "$SECURITY_DIR/module/securityLog.sh"
source "$SECURITY_DIR/module/Initialize_variables.sh"

# 1. 계정 관리
source "$CHECK_DIR/U-01.sh"
source "$CHECK_DIR/U-02.sh"
source "$CHECK_DIR/U-03.sh"
source "$CHECK_DIR/U-04.sh"
source "$CHECK_DIR/U-45.sh"
source "$CHECK_DIR/U-46.sh"
source "$CHECK_DIR/U-47.sh"
source "$CHECK_DIR/U-48.sh"
source "$CHECK_DIR/U-54.sh"
## 2. 파일 및 디렉터리 관리
source "$CHECK_DIR/U-07.sh"
source "$CHECK_DIR/U-08.sh"
source "$CHECK_DIR/U-09.sh"
source "$CHECK_DIR/U-10.sh"
source "$CHECK_DIR/U-11.sh"
source "$CHECK_DIR/U-12.sh"
source "$CHECK_DIR/U-14.sh"
source "$CHECK_DIR/U-56.sh"
## 3. 서비스 관리
source "$CHECK_DIR/U-20.sh"
source "$CHECK_DIR/U-22.sh"
source "$CHECK_DIR/U-65.sh"
source "$CHECK_DIR/U-68.sh"
source "$CHECK_DIR/U-69.sh"
## 5. 로그 관리 
source "$CHECK_DIR/U-72.sh"
